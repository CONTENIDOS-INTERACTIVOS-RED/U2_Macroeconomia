  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Modelo de crecimiento económico',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '3.1',
            titulo: 'Definición del modelo de crecimiento económico',
            hash: 't_3_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.2',
            titulo: 'Tipos de crecimiento económico ',
            hash: 't_3_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.3',
            titulo: 'Factores que impulsan el crecimiento económico',
            hash: 't_3_3',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.4',
            titulo: 'Ciclos económicos',
            hash: 't_3_4',
          },
        ],
      },
